...
${nuget_cmd} install src/UkraineAlarm/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/UkraineAlarm.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/UkraineAlarm.dll \
-recurse:'src/UkraineAlarm/*.cs' \
-doc:bin/UkraineAlarm.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/UkraineAlarm.dll was created successfully"
fi
